...
const features = [
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/></svg>, title: "Logo Design", desc: "primary mark, secondary mark, and icon variants in full colour and mono." },
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>, title: "Colour Palette", desc: "primary, secondary, and accent colours with hex and RGB values." },
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18"><polyline points="4 7 4 4 20 4 20 7"/><line x1="9" y1="20" x2="15" y2="20"/><line x1="12" y1="4" x2="12" y2="20"/></svg>, title: "Typography System", desc: "font pairing, weights, and hierarchy for web and print." },
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/></svg>, title: "Brand Guidelines", desc: "usage rules, spacing, do's and don'ts in one clean document." },
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>, title: "Social Media Kit", desc: "profile banners, post templates, and story formats ready to use." },
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18"><path d="M12 2v20M2 12h20"/></svg>, title: "Business Cards", desc: "print-ready designs that match your new identity." },
];

const packages = [
  { name: "Logo Only", price: "R2,500", features: ["Primary + secondary logo", "Icon / favicon", "Full colour + mono", "PNG, SVG, WebP formats"], cta: "Get Logo" },
  { name: "Brand Kit", price: "R5,000–8,000", features: ["Everything in Logo Only", "Colour palette + typography", "Brand guidelines (PDF)", "Social media templates"], cta: "Get Brand Kit", highlight: true },
  { name: "Full Identity", price: "R12,000+", features: ["Everything in Brand Kit", "Stationery suite", "Print collateral", "Rollout support (3 months)"], cta: "Get Full Identity" },
];
